    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                console.log(config);
                if (!config) {
                    return [2 /*return*/, res.status(404).json({ error: "Configuration not found" })];
                }
                tenant = config.tenant, clientSecret = config.clientSecret, clientId = config.clientId;
                url = "https://login.microsoftonline.com/".concat(tenant, "/oauth2/v2.0/token");
            ...
            case 3:
                e_1 = _a.sent();
                console.error("Error fetching token:", e_1);
                return [2 /*return*/, res
                        .status(500)
...
var GetBcConfig = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var config, e_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 2:
                e_2 = _a.sent();
                console.error("Error fetching config:", e_2);
                return [2 /*return*/, res
                        .status(500)
...
//# sourceMappingURL=BcAuthControllers.js.map